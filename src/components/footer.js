const navigation = [
  {
    ...
    items: [
      ...
      {
        name: "Email: sales@kingjetprinters.com",
        href: "mailto:sales@kingjetprinters.com",
      },
    ],
  },
  {
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-300">
              ...
              player in textiles and manufacturing. Partnering with KingJet
              (Guangzhou) Digital Technology Co., Ltd., renowned for 18 years of
              innovation in digital printing, we proudly represent the global
              “KINGJET金捷®” brand.
              <br />
              <br />
              ...
              printers, films, inks, and top-notch customer service. At KingJet
              Printers Canada, we’re not just suppliers—we’re your dedicated
              partner in business growth, offering expert Canadian technical
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-400">
            &copy; 2024 KingJetPrinters, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
